...
physical system that can be measured during execution. Our work
in~\cite{braida2024unstructured} asks a concrete question: Can this limitation be
overcome when one only has access to a device operating in the adiabatic setting?
