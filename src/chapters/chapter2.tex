...
The dependence on model choice will recur throughout this thesis. Physical
assumptions determine a computational model. The model determines a resource
accounting. And the resource accounting supports, or fails to support, a
complexity claim. Chapters~3 and~4 will put this chain under pressure: the
...
The vocabulary is now in place. The modeling chain makes explicit that
complexity claims depend on the computational model. Energy plays a double role as generator of
