...
Let $\Gamma$ be a circle in the complex plane centered at $\lambda_0(s)$ with radius $g(s)/2$. The Riesz integral representation of the spectral projector, introduced by Kato~\cite{Kato1950} in his foundational 1950 proof of the adiabatic theorem, expresses the projector as a contour integral of the resolvent. The integration-by-parts technique for controlling adiabatic transitions that follows is standard in adiabatic perturbation theory, going back to the same work. The representation gives
\begin{equation}
